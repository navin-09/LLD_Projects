...
import com.navin.bookmyshow.models.*;
import com.navin.bookmyshow.repositories.BookingRepository;
import com.navin.bookmyshow.repositories.ShowRepository;
import com.navin.bookmyshow.repositories.ShowSeatRepository;
        ...
        for (ShowSeat showSeat : showSeats) {
            if (!(showSeat.getShowSeatStatus().equals(ShowSeatStatus.EMPTY) ||
                    (showSeat.getShowSeatStatus().equals(ShowSeatStatus.BLOCKED) &&
                            Duration.between(showSeat.getBlockedAt().toInstant(), new Date().toInstant())
                                    .toMinutes() > 15))) {
